...
class Action {
    constructor(stateStore, profileInstaller, profileUninstaller) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ProfileInstaller = void 0;
const path = __importStar(__nccwpck_require__(1017));
const constants_1 = __nccwpck_require__(5105);
class ProfileInstaller {
    constructor(generateFilename, decodeBase64, mkdir, writeFile, logger) {
    ...
    install(base64, baseFilename) {
        const filename = this.generateFilename(baseFilename);
        const filePath = path.join(constants_1.PROVISIONING_PROFILES_DIR, filename);
        let contents = this.decodeBase64(base64);
        this.mkdir(constants_1.PROVISIONING_PROFILES_DIR);
        this.writeFile(filePath, contents);
        this.logger.info("Installed " + filePath);
        return filePath;
    }
}
exports.ProfileInstaller = ProfileInstaller;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ProfileUninstaller = void 0;
class ProfileUninstaller {
    constructor(fileRemover, logger) {
...
exports.ProfileUninstaller = ProfileUninstaller;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PROVISIONING_PROFILES_DIR = void 0;
exports.PROVISIONING_PROFILES_DIR = "~/Library/MobileDevice/Provisioning Profiles";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const decode_base64_1 = __nccwpck_require__(9972);
const generate_filename_1 = __nccwpck_require__(8912);
const make_dir_1 = __nccwpck_require__(3966);
const remove_file_1 = __nccwpck_require__(8491);
const write_file_1 = __nccwpck_require__(1958);
const Action_1 = __nccwpck_require__(3658);
const StateStore_1 = __nccwpck_require__(8805);
const ProfileInstaller_1 = __nccwpck_require__(5474);
const ProfileUninstaller_1 = __nccwpck_require__(8781);
const Logger_1 = __nccwpck_require__(7700);
const get_options_1 = __nccwpck_require__(7970);
const stateStore = new StateStore_1.StateStore(core);
const logger = new Logger_1.Logger(core);
const profileInstaller = new ProfileInstaller_1.ProfileInstaller(generate_filename_1.generateFilename, decode_base64_1.decodeBase64, make_dir_1.makeDir, write_file_1.writeFile, logger);
const profileUninstaller = new ProfileUninstaller_1.ProfileUninstaller(remove_file_1.removeFile, logger);
...
function generateFilename(filename) {
    const baseFilename = filename || (0, uuid_1.v4)();
